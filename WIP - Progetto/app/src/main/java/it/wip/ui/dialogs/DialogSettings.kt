...
import it.wip.R
import it.wip.databinding.DialogSettingsBinding
...
class DialogSettings : DialogFragment(){
    ...
    override fun onCreateView(
        ...
        val binding: DialogSettingsBinding = DataBindingUtil.inflate(inflater, R.layout.dialog_settings, container, false)
