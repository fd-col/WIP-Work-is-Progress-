...
fun seed(wipDb: WIPDatabase) {
    ...
    wipDb.chapterDao().insertWithoutCoroutines(
        Chapter(1, "Capitol1",
            "00.05.01", "21/06/22 10.20.20", 1, 1),
        Chapter(2, "Capitol2",
        "1.07.12", "20/06/22 15.20.20", 2, 1),
        Chapter(3, "Capitol3",
        "2.07.56", "19/06/22 16.20.20", 2, 1),
        Chapter(4, "Capitol4",
        "4.01.26", "18/06/22 16.20.20", 2, 1),
        Chapter(5, "Capitol5",
            "01.23.45", "17/06/22 17.20.20", 5, 1),
        Chapter(6, "Capitol6",
            "00.07.02", "16/06/22 18.20.20", 3, 1),
        Chapter(7, "Capitol7",
            "03.21.32", "15/06/22 19.20.20", 7, 1),
        Chapter(8,"Capitol8",
